...
export function register(context: vscode.ExtensionContext, utils: NavigationUtils): void {
    context.subscriptions.push(
        vscode.commands.registerCommand('todo-tree.goToNext', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('todo-tree.goToPrevious', () => {
            const editor = vscode.window.activeTextEditor;
            if (!editor) return;
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('todo-tree.revealInFile', (uri: vscode.Uri, selection: unknown) => {
