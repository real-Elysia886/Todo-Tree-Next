...
export function registerCommands(ctx: ScopeContext): vscode.Disposable[] {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.showOnlyThisFolder', (node: ScopeNode | undefined) => {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.showOnlyThisFolderAndSubfolders', (node: ScopeNode | undefined) => {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.excludeThisFolder', (node: ScopeNode | undefined) => {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.excludeThisFile', (node: ScopeNode | undefined) => {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.switchScope', () => {
            const scopes = vscode.workspace
                .getConfiguration('todo-tree.filtering')
                .get<Array<{ name: string; includeGlobs?: unknown; excludeGlobs?: unknown }>>('scopes');
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.removeFilter', () => {
    ...
    disposables.push(
        vscode.commands.registerCommand('todo-tree.resetAllFilters', () => {
