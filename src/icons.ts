...
const octicons = require('@primer/octicons') as any;

import * as utils from './utils';
import * as attributes from './attributes';
import themeColourNames = require('./themeColourNames');
import codiconNames = require('./codiconNames');
import productIconNames = require('./productIconNames');

export function getIcon(
    context: vscode.ExtensionContext,
    tag: string,
    debug?: (text: string) => void
): vscode.ThemeIcon | { dark: string; light: string } {
    ...
    if (iconName === 'todo-tree' || iconName === 'todo-tree-filled') {
        ...
        let themeColour: vscode.ThemeColor | undefined;
...
export function validateIcons(workspace: typeof vscode.workspace): string {
    function checkIcon(setting: string) {
